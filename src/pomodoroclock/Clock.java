...
public class Clock extends javax.swing.JFrame {
    ...
    private void boxPersonalizadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxPersonalizadoActionPerformed
        // TODO add your handling code here:
        selecao();
    }//GEN-LAST:event_boxPersonalizadoActionPerformed

    private void boxPadraoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxPadraoActionPerformed
        // TODO add your handling code here:
        selecao();
    ...
    /*
    public void pausarTimer(int seg, int min, int seg2, int min2) {
        segPauseT = seg;
        minPauseT = min;
        segPauseP = seg2;
        minPauseP = min2;
            ...
            public void run() {
                if (pause && start) {
                    if (stop == false && reset == false) {
                        ...
                        textSession.setText("Working Session!");
                        textSession.setForeground(Color.red);
                        labelSegundos.setText(Integer.toString(segPauseT));
                        labelMinutos.setText(Integer.toString(minPauseT));
                        segPauseT--;
                        if (segPauseT == -1) {
                            segPauseT = 59;
                            if ((minPauseT - 1) != -1) {
                        ...
                        if (pausa) {
                            textSession.setText("Break Session!");
                            textSession.setForeground(Color.green);
                            labelSegundos.setText(Integer.toString(segPauseP));
                            labelMinutos.setText(Integer.toString(minPauseP));
                            segPauseP--;
                            if (segPauseP == -1) {
                                segPauseP = 59;
                                if ((minPauseP - 1) != -1) {
